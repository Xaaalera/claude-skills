---
description: Use when adding a new route, adding a nav item to the sidebar, or modifying routing/navigation in the <ui-repo> project.
---
...
src/config/
  ...
  navigation/
    sidebar/
      ...
      Fiscal.ts    ← Fiscal section items
...
```ts
// e.g. src/config/navigation/sidebar/Fiscal.ts
