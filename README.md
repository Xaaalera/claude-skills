...
<tr><td><code>frontend-react_routing-config</code></td><td>Use when adding a new route, adding a nav item to the sidebar, or modifying routing/navigation in the <ui-repo> project.</td></tr>
</table>
