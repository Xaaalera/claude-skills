#!/usr/bin/env bash
# One-command adoption of the docs standard. Run from the root of the repo you want to protect:
#   bash <(gh api repos/Xaaalera/claude-skills/contents/plugins/docs/bootstrap.sh -H "Accept: application/vnd.github.raw")
...
bash "$tmp/plugins/docs/install.sh" "$TARGET"
